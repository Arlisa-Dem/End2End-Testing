...
public class UI_StepDefs {
    ...
    public void user_enters_room_number(String roomNumber) {
        int fakeRoomNumber = Faker.instance().number().numberBetween(100000,10000000);
    ...
    public void user_selects(String roomType) {
        ...
        //Reusable method -->Driver.selectByVisibleText(medunnaRoomPage.roomType, roomType + Keys.ENTER);
         }
